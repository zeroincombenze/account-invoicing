...
--- | --- | --- | ---
[account_invoice_blocking](account_invoice_blocking/) | 9.0.1.0.0 | :repeat: | This module allows the user to set a blocking (No Follow-up) flag on invoices.
[account_invoice_check_total](account_invoice_check_total/) | 9.0.1.0.0 | :repeat: | Check if the verification total is equal to the bill's total
[account_invoice_fiscal_position_update](account_invoice_fiscal_position_update/) | 9.0.1.0.0 | :repeat: | Changing the fiscal position of an invoice will auto-update invoice lines
[account_invoice_merge](account_invoice_merge/) | 9.0.1.0.0 | 9.0.1.0.1 | Account Invoice Merge Wizard
...
[account_invoice_supplier_ref_unique](account_invoice_supplier_ref_unique/) | 9.0.1.0.0 | :repeat: | Checks that supplier invoices are not entered twice
[account_invoice_view_payment](account_invoice_view_payment/) | 9.0.1.0.0 | :repeat: | Access to the payment from an invoice
[account_payment_term_extension](account_payment_term_extension/) | 9.0.1.0.0 | :repeat: | Adds rounding, months, weeks and multiple payment days properties on payment term lines
[purchase_batch_invoicing](purchase_batch_invoicing/) | 9.0.1.0.0 | :repeat: | Make invoices for all ready purchase orders
[purchase_stock_picking_return_invoicing](purchase_stock_picking_return_invoicing/) | 9.0.1.0.0 | 9.0.1.1.0 | Add an option to refund returned pickings
[sale_stock_picking_return_invoicing](sale_stock_picking_return_invoicing/) | 9.0.1.0.0 | :repeat: | Add an option to refund return pickings
[sale_timesheet_invoice_description](sale_timesheet_invoice_description/) | 9.0.1.0.0 | :repeat: | Add timesheet details in invoice line
...
addon | version | OCA version | summary
--- | --- | --- | ---
[account_group_invoice_lines](account_group_invoice_lines/) | 8.0.1.1.0 (unported) | :repeat: | Add option to group invoice line per account
...
[account_invoice_force_number](account_invoice_force_number/) | 8.0.0.1.0 (unported) | :repeat: | Allows to force invoice numbering on specific invoices
[account_invoice_line_description](account_invoice_line_description/) | 8.0.1.0.0 (unported) | :repeat: | Account invoice line description
...
[account_invoice_partner](account_invoice_partner/) | 8.0.0.2.0 (unported) | :repeat: | Automatically select invoicing partner on invoice
...
[account_invoice_shipping_address](account_invoice_shipping_address/) | 8.0.0.1.1 (unported) | :repeat: | Adds a shipping address field to the invoice.
