...
============================================
|icon| Pro forma invoice sequence 10.0.1.0.1
============================================


**Bind a sequence to pro-forma invoices**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-invoicing/10.0/account_invoice_pro_forma_sequence/static/description/icon.png
...
|en| This module allows to track pro-forma invoices with sequences.
...
::
    ...
    odoo_install_repository account-invoicing -b 10.0 -O zero -o $HOME/10.0
...
* |menu| Setting > Apps |right_do| Select **account_invoice_pro_forma_sequence** > Install
...
::
    ...
    odoo_install_repository account-invoicing -b 10.0 -o $HOME/10.0 -U
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_invoice_pro_forma_sequence** > Update
