========================================================================
|icon| Account Invoice - Currency Date/Data valuta in fattura 12.0.0.1.0
========================================================================

**Store currency date on invoice for specific currency rate**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-invoicing/12.0/account_invoice_date_currency/static/description/icon.png
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/account-invoicing/12.0/account_invoice_date_currency/static/description/description.png
...
::
    ...
    deploy_odoo clone -r account-invoicing -b 12.0 -G zero -p $HOME/12.0
...
::
    ...
    deploy_odoo update -r account-invoicing -b 12.0 -G zero -p $HOME/12.0
    vem amend $HOME/12.0/venv_odoo
...
12.0.0.1.0 (2024-02-22)
~~~~~~~~~~~~~~~~~~~~~~~

* [IMP] First version
* [QUA] Test coverage 86% (14: 2+12) [0 TestPoints] - quality rating 52 (target 100)
...
Last Update / Ultimo aggiornamento: 2024-02-22
